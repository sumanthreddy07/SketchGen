...
class Seq2seqModel(object):
    ...
    def build_model(self):
        ...
        [decoder_output, _, _] = self.decoder(decoder_full_input, initial_state=[init_h, init_c])
    ...
    def calculate_kl_loss(self, *args, **kwargs):
        """ Function to calculate the KL loss term.Considers the tolerance value for which optimization for KL should stop """
    ...
    def calculate_md_loss(self, y_true, y_pred):
        ...
        r_cost = K.mean(result)  # Keras already averages over all tensor values, this might be redundant
    ...
    def make_sampling_models(self):
        #""" Creates models for various input-output combinations that are used when sampling and encoding\decoding specific strokes """
        models = {}
